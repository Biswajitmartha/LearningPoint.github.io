<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true" CodeFile="User_DownloadVideos.aspx.cs" Inherits="User_DownloadVideos" %>
...
&lt;img 
    src=&quot;img/down.png&quot; height=&quot;15px&quot; width=&quot;15px&quot; border=&quot;0&quot; alt=&quot;Sure to Delete&quot; /&gt;
                                "></asp:LinkButton>
                                    ...
                                    <asp:TemplateField HeaderText="Video No">
                                        <ItemTemplate>
                                            <asp:Label ID="Label2" runat="server" Text='<%# Bind("ELN_vid_no") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("ELN_vid_no") %>'></asp:TextBox>
                                        </EditItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Video Name">
                                        <ItemTemplate>
                                            <asp:Label ID="Label3" runat="server" Text='<%# Bind("ELN_vid_Name") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Video Subject">
                                        <ItemTemplate>
                                            <asp:Label ID="Label4" runat="server" Text='<%# Bind("ELN_vid_Subject") %>'></asp:Label>
                                        </ItemTemplate>
                                        <EditItemTemplate>
