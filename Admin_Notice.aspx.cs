...
public partial class Admin_Notice : System.Web.UI.Page
{
    ...
    private void fun1()
    {
        ...
        con.Close();
        con.Open();
        str = "SELECT  *  FROM ELN_Notice where ELN_Notice_no='" + TextBox1.Text + "' ";
        DataSet ds = new DataSet();
        SqlDataAdapter da = new SqlDataAdapter(str, con);
        da.Fill(ds, "ELN_Notice");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if ((fu1.PostedFile != null) && (fu1.PostedFile.ContentLength >= 0))
        {
            ...
            if (File.Exists(Server.MapPath("~/notice/") + "\\" + filename1))
            {
                filename1 = fu1.PostedFile.FileName.ToString() + "1";
                fu1.SaveAs(Server.MapPath("~/notice/") + "\\" + filename1);
                filename1 = "~/notice/" + filename1.ToString();
        ...
        cmd = new SqlCommand("UPDATE ELN_Notice SET ELN_Notice_no=@1,ELN_Notice_Name=@2,ELN_Notice_Path=@4,ELN_Notice_Date=@5 where ELN_SlNo='" + HiddenField1.Value + "'", con);
    ...
    protected void lnkDel_Click(object sender, EventArgs e)
    {
        ...
        int result;
        con.Close(); con.Open();
        cmd = new SqlCommand("delete from ELN_Notice where ELN_SlNo=" + ID, con);
    ...
    protected void lnkDelete_Click(object sender, EventArgs e)
    {
        ...
        strSQL = "select *  from ELN_Notice where ELN_SlNo='" + ID + "'";
        con.Close();
        con.Open();
        ...
        if (dr.Read())
        {
            ...
            TextBox1.Text = dr["ELN_Notice_no"].ToString();
            TextBox22.Text = dr["ELN_Notice_Name"].ToString();
            Label47.Text = dr["ELN_Notice_Path"].ToString();
            TextBox2.Text = dr["ELN_Notice_Date"].ToString();
        }
    }
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand("insert into ELN_Notice values(@1,@2,@4,@5)", con);
        cmd.Parameters.Add(new SqlParameter("@1", TextBox1.Text));
        cmd.Parameters.Add(new SqlParameter("@2", TextBox22.Text));
        cmd.Parameters.Add(new SqlParameter("@4", filename1.ToString()));
        cmd.Parameters.Add(new SqlParameter("@5", TextBox2.Text));
