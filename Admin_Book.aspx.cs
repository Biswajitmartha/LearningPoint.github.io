...
public partial class Admin_Book : System.Web.UI.Page
{
    ...
    private void fun1()
    {
        ...
        con.Close();
        con.Open();
        str = "SELECT  *  FROM ELN_Books where ELN_books_Subject='" + DropDownList1.Text + "' ";
        DataSet ds = new DataSet();
        SqlDataAdapter da = new SqlDataAdapter(str, con);
        da.Fill(ds, "ELN_mat_Subject");
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if ((fu1.PostedFile != null) && (fu1.PostedFile.ContentLength >= 0))
        {
            ...
            if (File.Exists(Server.MapPath("~/books/") + "\\" + filename1))
            {
                filename1 = fu1.PostedFile.FileName.ToString() + "1";
                fu1.SaveAs(Server.MapPath("~/books/") + "\\" + filename1);
                filename1 = "~/books/" + filename1.ToString();
        ...
        cmd = new SqlCommand("UPDATE ELN_Books SET ELN_books_no=@1,ELN_books_Name=@2,ELN_books_Subject=@3,ELN_books_Path=@4,ELN_books_Date=@5 where ELN_SlNo='" + HiddenField1.Value + "'", con);
    ...
    protected void lnkDel_Click(object sender, EventArgs e)
    {
        ...
        int result;
        con.Close(); con.Open();
        cmd = new SqlCommand("delete from ELN_Material where ELN_SlNo=" + ID, con);
    ...
    protected void lnkDelete_Click(object sender, EventArgs e)
    {
        ...
        strSQL = "select *  from ELN_Books where ELN_SlNo='" + ID + "'";
        con.Close();
        con.Open();
        ...
        if (dr.Read())
        {
            ...
            TextBox23.Text = dr["ELN_books_no"].ToString();
            TextBox22.Text = dr["ELN_books_Name"].ToString();
            DropDownList1.SelectedValue = dr["ELN_books_Subject"].ToString();
            Label47.Text = dr["ELN_books_Path"].ToString();
            TextBox2.Text = dr["ELN_books_Date"].ToString();
        }
    }
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        cmd = new SqlCommand("insert into ELN_Books values(@1,@2,@3,@4,@5)", con);
        cmd.Parameters.Add(new SqlParameter("@1", TextBox23.Text));
        cmd.Parameters.Add(new SqlParameter("@2", TextBox22.Text));
        cmd.Parameters.Add(new SqlParameter("@3", DropDownList1.Text));
        cmd.Parameters.Add(new SqlParameter("@4", filename1.ToString()));
