...
public partial class Teacher_uploadNotice : System.Web.UI.Page
{
    ...
    private void fun1()
    {
        ...
        str = "SELECT  *  FROM ELN_Notice where ELN_Notice_no='" +TextBox23.Text+ "' ";
    ...
    protected void lnkDel_Click(object sender, EventArgs e)
    {
        ...
        strSQL = "select ELN_mat_Path from ELN_Material where ELN_SlNo='" + ID + "'";
        cmd = new SqlCommand(strSQL, con);
        dr = cmd.ExecuteReader();
        if (dr.Read())
        {
            string del = dr["ELN_Notice_Path"].ToString();
