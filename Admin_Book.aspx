<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Admin_Book.aspx.cs" Inherits="Admin_Book" %>
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <asp:LinkButton ID="lnkDel" runat="server" 
                                                                        ...
                                                                        PostBackUrl="~/Admin_Book.aspx" Text="
&lt;img 
...
&lt;img 
    src=&quot;img/edit.png&quot; height=&quot;15px&quot; width=&quot;15px&quot; border=&quot;0&quot; alt=&quot;Sure to Delete&quot; /&gt;
                                "></asp:LinkButton>
                                    ...
                                    <asp:TemplateField HeaderText="Book / Auther Name">
                                        <ItemTemplate>
                    ...
                    <tr>
                        <td align="left">
                            <asp:Label ID="Label48" runat="server" ForeColor="Black" Text="BOOK No :"></asp:Label>
                        </td>
                        <td align="left">
                    ...
                    <tr>
                        <td align="left">
                            <asp:Label ID="Label50" runat="server" ForeColor="Black" 
                                Text="BOOK Name / Auther Name :"></asp:Label>
                        </td>
                        <td align="left">
