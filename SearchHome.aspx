<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SearchHome.aspx.cs" Inherits="SearchHome" %>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><asp:Image ID="Image0" runat="server" ImageUrl="~/assets/images/logo.png"></asp:Image></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <asp:Image ID="Image2" class="img-circle" runat="server" ImageUrl="~/assets/images/defuser.png"></asp:Image>
              <span class="hidden-xs"><asp:Label ID="Label2" runat="server" Text="Label"></asp:Label></span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                
                <asp:Image ID="Image1" runat="server" class="img-circle" ImageUrl="~/assets/images/defuser.png"></asp:Image>
                <p>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <asp:Image ID="Image3" class="img-circle" runat="server" ImageUrl="~/assets/images/defuser.png"></asp:Image>
        </div>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2019 <a href="https://www.enyride.com">enyride travel management</a>.</strong> All rights
    reserved.
  </footer>
