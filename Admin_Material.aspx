<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.master" AutoEventWireup="true" CodeFile="Admin_Material.aspx.cs" Inherits="Admin_Material" %>
                                                            ...
                                                            <tr>
                                                                <td align="center">
                                                                    <asp:LinkButton ID="lnkDel" runat="server" 
                                                                        ...
                                                                        PostBackUrl="~/Admin_Material.aspx" Text="
&lt;img 
...
&lt;img 
    src=&quot;img/edit.png&quot; height=&quot;15px&quot; width=&quot;15px&quot; border=&quot;0&quot; alt=&quot;Sure to Delete&quot; /&gt;
                    ...
                    <tr>
                        <td align="left">
                            <asp:Label ID="Label48" runat="server" ForeColor="Black" Text="Material No :"></asp:Label>
                        </td>
                        <td align="left">
                    ...
                    <tr>
                        <td align="left">
                            <asp:Label ID="Label2" runat="server" ForeColor="Black" Text="Material Name :"></asp:Label>
                        </td>
                        <td align="left">
                    ...
                    <tr>
                        <td align="left">
                            <asp:Label ID="Label3" runat="server" ForeColor="Black" Text="Upload File :"></asp:Label>
                        </td>
                        <td align="left">
                    ...
                    <tr>
                        <td align="left">
                            <asp:Label ID="Label4" runat="server" ForeColor="Black" Text="Date :"></asp:Label>
                        </td>
                        <td align="left">
